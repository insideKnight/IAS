...
set "blank="
set "mas=ht%blank%tps%blank%://celesto.cpanelcentral.com/"
...
for /f "delims=[] tokens=2" %%# in ('ping -4 -n 1 iasupdatecheck.cpanelcentral.com') do (
...
choice /C:10 /N
if !errorlevel!==2 rem
if !errorlevel!==1 (start https://celesto.cpanelcentral.com/ & exit /b)
)
)
...
echo:
echo Check this page for help. %mas%activation
goto done2
)
...
if %_erl%==5 exit /b
if %_erl%==4 start https://celesto.cpanelcentral.com/ & goto MainMenu
